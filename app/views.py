...
def sport_shot_model(request): 
    ...
    if request.method == "POST":
        ...
        models = keras.models.load_model('C:/Users/prem1/Downloads/ITPDL12-FINAL/ITPDL12-FINAL/ITPDL12-FINAL CODING/Deploy/project/app/sport_shot.h5')
        data = np.ndarray(shape=(1, 224, 224, 3), dtype=np.float32)
        image = Image.open("C:/Users/prem1/Downloads/ITPDL12-FINAL/ITPDL12-FINAL/ITPDL12-FINAL CODING/Deploy/project/media/images/" + str(result1)).convert("RGB")
        size = (224, 224)
...
Model1 = joblib.load('app/player_performence.pkl')  
# players performence
...
Model = joblib.load('app/batsman_auction12.pkl')  
